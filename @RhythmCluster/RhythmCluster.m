classdef RhythmCluster < handle
    ...
    methods
        function obj = RhythmCluster(dataset, feat_type, frame_length, ...
            ...
            % default path to cluster_assignments generated by Maarten's
            % python script
        ...
        function obj = add_training_data(dataset)
            % load list of training files
            if strfind(dataset, '.lab')
                obj.train_lab_fln = dataset;
                [~, obj.dataset, ~] = fileparts(dataset);
            else
                obj.train_lab_fln = fullfile('~/diss/data/beats/lab_files', ...
                    [dataset, '.lab']);
                obj.dataset = dataset;
            end
            if exist(obj.train_lab_fln, 'file')
            ...
            fprintf('Updated training data to %s\n', dataset);
        end
